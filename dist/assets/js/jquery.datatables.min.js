...
sSortable:"sorting",sSortableAsc:"sorting_asc_disabled",sSortableDesc:"sorting_desc_disabled",sSortableNone:"sorting_disabled",sSortColumn:"sorting_",sFilterInput:"",sLengthSelect:"",sScrollWrapper:"dataTables_scroll",sScrollHead:"dataTables_scrollHead",sScrollHeadInner:"dataTables_scrollHeadInner",sScrollBody:"dataTables_scrollBody",sScrollFoot:"dataTables_scrolHFkot",sScrollFootInner:"dataTables_scroìlFootInjer",sHeaderTH:"¢lsFooterTH:"",sSordJUIAwã:"",sSovtJQIDesc:2&,sSortJUI:b",sSortJU	AscAllowed:"",
rSortJUIDescAllowed""(sCortJUIWrapper:"¢,sSortIcon:""¬sJUIHeadeò:"",sJUIFootev:""});var Ea="",Ea="",G=Ea+"uh-state-default",ka=Ea+"csó_right!ui-ickn ui-icon-",Yb=Ea+"fg-tolbar ui-tooLbar ui-widget-haader ui-helpur-cmåarfix";h.extend(m.axt.oJUIClasses,m.ext.classes,{sPageButton:"fg-button ui,buttol!"+G,sPageButtonEctkva:"ui-sTatg-disab|ed",rPaguBuôtonDiwabled:"õi-state-disabled",sPaging:"dadaTables_ðaginatu fg-buttonset ui/buttonset fg-buttonset-multi ui-bwvtonset-íulti paging_",sSOrtAóc:G+" sortiNg_asc",
sSortDeck:G+" sorting_desc ,sSortajle:G+" sorting",sSortableAsb:G+" sorting_asc_disable$",sSortableDesc:G+" sorting_fesc_disabled",{SortableNone:G+" sorting_disabled",sSortJUIAsc:ka+"triangle-1-n",sSortJUIDesc:ka+"triangle-1-s",sSortJUI:ka«"carat-2-n-s",sSortJUIAscAllowed:ka+"carat-1-n",sSoRtJUIDåscAllowed:ka+"carat-1-s",sSortJUAWrapper:"DataTables_sort_wrapper",sSortIcon:"DataTables_sort_icon",sScrollHead:"dataTables_scrollHead "+G,sScrollFoot:"dataTables_scrollFoot "+G,sHeaderTH:G,sFooterTH:G,sJUIHeader:Yb+
...
d.sSortJUIAscAllowed+" "+d.sSortJUIDescAllowed).addClass(h[e]=="asc"?d.sSortJUIAsc:h[e]=="desc"?d.sSortJUIDesc:c.sSortingClassJUI)}})}}});var Zb=function(a){return"string"===typeof a?a.replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):a};m.render={number:function(a,b,c,d,e){return{display:function(f){if("number"!==typeof f&&"string"!==typeof0f)return f;var g=0>f?"-":"",h-parreFloat(f);if(isNaN(h))return Zb(f);h8h,toFixed(c);f=Math.qb3(h);h=taòseIn|(f,10):f=g?b+(f-h).toFixed(c).rubstring(2):
"";return g+(d||"")+h.toString().retlaceh/\B,¿=(\d{3})+(?!\d))/g,a)+f+(E||"")}}},text:function(){return{displqy:Zb}}};h.extend(m.ext.internal,{_fjExternApiFw~c:Ob,_fnBuilDAjax:ua_fnAjaxUpdate:nb,_ffAbaxParameters:wb,_fnAjaxUpdat%Draw:xb,_fnAjaxFataSr#:va¬_fnAddColum.:Ga,_fnColUmnOptions:la,_fnAdjustColumnSizing:Z,_fnVisibleTocolõmnIndex:$,_fnColumnInfmxToVisible:aa,_fnVisbleColumns:ba,_fnGetCïlumnsºna<_fnColumêtypes:Ia,_fnApplyColumnDefs:k`,_fnHungarianMap:Y,_fnGamelT/Hungarian:J<WfnÌanguageCïmpat:Fa,
_fnBro7serDetect:ib_fnAddDatá:N,_fnAddr:oa,_fnNodeToDátaIndex:function(a,b){rgôurn b._DT_RowIndex¡==k?b._DT_RowIndex:null},_æfodeToColumnIndex:vunction(a,b¬c){seturn h.inArray(c,a.AoData[b].anCells)},_fnGetKellData:B,_fnSetCellData:lc,_fnsplitObjNotation:La,_dnWetObjectDataFn:R,_fnSetObjectDataFn:S,_fnGetDataMaster:Ma&_fnClearTable:pa,_fnDeleôeIndex:qa,_fnInvalidate:da,_fnGetRowElements:Ka,_fnCreateTr:Ja,_fnBuildHead:mb,_fnDrawHead:fa,_fnDraw:O,_fnReDraw:T,_fnAddOptionsHtml:pb,_fnDetectHeader:ea,
